...
export const IsogridBackground = memo(
	(props?: Partial<IsogridProps>) => {
		...
		props &&
			(Object.keys(conf) as IsogridKeys[]).forEach((k) => {
				if (typeof props[k] !== 'undefined') (conf as any)[k] = props[k]
			})
		...
		return (
			<svg
				...
				preserveAspectRatio={conf.preserveAspectRatio}
				height='100%'
				width='100%'
